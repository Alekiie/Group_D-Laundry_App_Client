    ...
    <Container>
      <Row className="my-2">
        <Col md={6}>
          ...
          <div>
            ...
            <div className="terms mb-5">
              <li className="mt-3">
                After service completion you have to pay through online or Cash
                on Delivery.
              </li>
              <li className="mt-3">
                Price may differ due to product fabrication and measurement of
                their length. It will be based on our respective Service
                Provider’s inspection.
              </li>
              <li className="mt-3">
                Service Delivery time might extended or changes due to product
                fabrics as in leather Jacket, Carpet etc.
              </li>
              <li className="mt-3">
                Delivery time also might changed upon transportation crisis like
        ...
        <Col md={6} className="mobileView">
          <h2 className="text-danger head-title mt-5 ml-5">
            Details of Services
          </h2>
          <p className="text-justify story ml-5">
            ...
            folds, packs and deliver at your doorstep.
